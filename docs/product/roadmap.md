...
|------|--------|------|------|
| Phase 1 — Foundation (core types, store, 3 MCP tools) | ✅ Shipped (`33184a7b`, PR #37 squash) | [multisource design §23 Ph1-2](../superpowers/specs/2026-05-29-anno-local-knowledge-service-multisource-design.md) | [phase 1 plan](../superpowers/plans/2026-05-29-anno-local-knowledge-service-phase1.md) |
| Phase 2 — Local folder source + privacy API | ✅ Shipped (`33184a7b`, follow-up privacy/forget fix `0978454e`) | [local folder source design](../superpowers/specs/2026-06-01-anno-knowledge-local-folder-source-phase2-design.md) | [phase 2 plan](../superpowers/plans/2026-06-01-anno-knowledge-local-folder-source-phase2.md) |
| Phase 2.5 — MCP surface consolidation | 📋 Reviewed, amend-before-execute | [consolidation design](../superpowers/specs/2026-06-02-anno-mcp-surface-consolidation-phase2.5-design.md) | [phase 2.5 plan](../superpowers/plans/2026-06-02-anno-mcp-surface-consolidation-phase2.5.md) |
...
**Scope:** ~300-500 LOC of routing in `anno-rag-mcp/src/lib.rs`, two small
legal-store helpers in `anno-rag`, one knowledge path-resolution helper, plus
tests. No storage migration and no model-loading behavior change. Cost: 1-2
weeks.

**Build fork:** CI for near-term execution should run on
[`candy-hacienda/anno`](https://github.com/candy-hacienda/anno). The original
`jamon8888/anno` Actions runs are currently blocked before job startup by
GitHub billing/spending-limit failures, so a green/failed build signal must
come from the build fork until that account issue is resolved.
