...
$Run = gh run list --repo jamon8888/anno --workflow Release --limit 5 --json databaseId,displayTitle |
  ConvertFrom-Json |
  Where-Object { $_.displayTitle -match 'v0\.11\.0-rc\.2' } |
