...
| `ner_pii_model_id` | `ANNO_RAG_NER_PII_MODEL` | `--ner-pii-model` | `"SemplificaAI/gliner2-multi-v1-onnx"` | 0.14 | HuggingFace model ID for the ONNX PII NER detector. Default: SemplificaAI/gliner2-multi-v1-onnx |
