...
| `ner_model_id` | `ANNO_RAG_NER_MODEL` | `--ner-model` | `"SemplificaAI/gliner2-multi-v1-onnx"` | 0.12 | HuggingFace model ID for the ONNX NER detector. Default: SemplificaAI/gliner2-privacy-filter-PII-multi |
