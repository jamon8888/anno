...
impl CDCRAdapter {
    ...
    pub fn clusters_to_crossdoc(
        merged: &[crate::cluster_encoder::MergedCluster],
        docs: &[crate::cdcr::Document],
    ) -> Vec<crate::cdcr::CrossDocCluster> {
        merged
            .iter()
            .map(|m| {
                let mut cluster = crate::cdcr::CrossDocCluster::new(
                    m.id as u64,
...
impl<E: ClusterEncoder, S: MergeScorer> UnifiedCrossContextResolver<E, S> {
    ...
    fn merge_clusters(
    ...
    ) -> Vec<crate::cluster_encoder::MergedCluster> {
        // Encode all clusters
        ...
        cluster_map
            ...
            .map(|(merged_id, (_root, indices))| {
                let mut merged = crate::cluster_encoder::MergedCluster {
                    id: merged_id,
...
impl IncrementalCorefAdapter {
    ...
    pub fn clusters_to_chains(
        merged: &[crate::cluster_encoder::MergedCluster],
    ) -> Vec<crate::coref::CorefChain> {
        use crate::coref::{CorefChain, Mention, MentionType};
...
pub struct WindowOutput {
    ...
    pub chains: Vec<crate::coref::CorefChain>,
}
...
impl WindowOutput {
    ...
    pub fn new(
        ...
        start_offset: usize,
        end_offset: usize,
        chains: Vec<crate::coref::CorefChain>,
    ) -> Self {
        Self {
            window_idx,
            start_offset,
...
mod tests {
    ...
    fn test_cdcr_adapter_empty() {
        let docs: Vec<crate::cdcr::Document> = vec![];
