...
use crate::datasets::GoldEntity;
use crate::loader::{DatasetId, DatasetLoader};
use crate::synthetic::{
    all_datasets, datasets_by_difficulty, datasets_by_domain, AnnotatedExample, Difficulty, Domain,
};
use crate::types::MetricWithVariance;
use crate::{evaluate_ner_model, TypeMetrics};
...
impl BackendRegistry {
    ...
    pub fn register_gliner2(&mut self, model_id: &str) {
        use anno::backends::gliner2::GLiNER2;
