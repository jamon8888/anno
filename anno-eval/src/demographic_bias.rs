...
pub struct DemographicBiasResults {
    ...
    pub statistical: Option<crate::bias_config::StatisticalBiasResults>,
    /// Frequency-weighted results (if enabled)
    pub frequency_weighted: Option<crate::bias_config::FrequencyWeightedResults>,
    /// Distribution validation (if enabled)
    pub distribution_validation: Option<crate::bias_config::DistributionValidation>,
}
...
pub struct DemographicBiasEvaluator {
    ...
    pub config: crate::bias_config::BiasDatasetConfig,
}
...
impl Default for DemographicBiasEvaluator {
    fn default() -> Self {
        Self {
            detailed: false,
            config: crate::bias_config::BiasDatasetConfig::default(),
        }
    }
}
...
impl DemographicBiasEvaluator {
    ...
    pub fn with_config(detailed: bool, config: crate::bias_config::BiasDatasetConfig) -> Self {
    ...
    pub fn evaluate_ner(&self, model: &dyn Model, names: &[NameExample]) -> DemographicBiasResults {
        ...
        let frequency_weighted = if self.config.frequency_weighted {
            ...
            Some(crate::bias_config::FrequencyWeightedResults::new(
                &recognized_flags,
                &frequencies,
                &name_strings,
            ))
        ...
        let statistical = if self.config.evaluation_seeds.len() > 1 {
            ...
            Some(crate::bias_config::StatisticalBiasResults::from_values(
                &values,
...
fn validate_demographic_distribution(
...
) -> crate::bias_config::DistributionValidation {
    ...
    crate::bias_config::DistributionValidation::validate(
        &normalized_observed,
        &reference,
        0.10, // 10% tolerance
    )
