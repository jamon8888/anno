...
#[cfg(feature = "eval-advanced")]
use crate::task_evaluator::{TaskEvalConfig, TaskEvaluator};
#[cfg(feature = "eval-advanced")]
use crate::task_mapping::Task;

#[cfg(feature = "eval-bias")]
use crate::bias_config::BiasDatasetConfig;
#[cfg(feature = "eval-bias")]
use crate::coref_resolver::SimpleCorefResolver;
#[cfg(feature = "eval-bias")]
use crate::demographic_bias::{create_diverse_name_dataset, DemographicBiasEvaluator};
#[cfg(feature = "eval-bias")]
use crate::gender_bias::{create_winobias_templates, GenderBiasEvaluator};
#[cfg(feature = "eval-bias")]
use crate::length_bias::{create_length_varied_dataset, EntityLengthEvaluator};
#[cfg(feature = "eval-bias")]
use crate::temporal_bias::{create_temporal_name_dataset, TemporalBiasEvaluator};

#[cfg(feature = "eval-advanced")]
use crate::backend_name::BackendName;
...
pub struct EvalSystem {
    ...
    coref_resolver: Option<std::sync::Arc<dyn crate::coref_resolver::CoreferenceResolver>>,
}
...
impl EvalSystem {
    ...
    pub fn with_coref_resolver(
        mut self,
        resolver: Box<dyn crate::coref_resolver::CoreferenceResolver>,
    ) -> Self {
    ...
    fn run_calibration(&self, warnings: &mut Vec<String>) -> Result<CalibrationEvalResults> {
        use crate::calibration::CalibrationEvaluator;
