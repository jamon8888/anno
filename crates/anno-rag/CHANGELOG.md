...
### Deferred
- **T4 — single-backend NER** (`StackedNER` → `GLiNER2Fastino` multi-v1). Blocked on v0.3 #001 landing on `main`. Will reduce peak RSS by an additional ~900 MB once integrated.
