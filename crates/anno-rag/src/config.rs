...
/// CLI overrides — full definition generated by `ConfigCliArgs` in Task 4.
/// Empty placeholder so `load()` compiles before Task 4.
...
impl AnnoRagConfig {
    ...
    fn apply_overrides(&mut self, _overrides: &ConfigOverrides) {
