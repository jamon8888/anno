...
//!
//! ```rust
//! use anno_eval::eval::abstract_anaphora::{
...
"#);
    ...
    <footer style="margin-top: 3rem; padding-top: 1rem; border-top: 1px solid var(--border); color: #8b949e; font-size: 0.9rem;">
        <p>Generated by <code>anno_eval::eval::abstract_anaphora</code></p>
        <p>See <code>docs/</code> for repo-local notes and entry points.</p>
    </footer>
</body>
</html>"#);
