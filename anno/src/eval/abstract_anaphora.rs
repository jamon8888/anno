...
//! not entities. See `docs/research/ABSTRACT_ANAPHORA_RESEARCH.md` for full treatment.
//!
//! # Key Papers
//!
...
"#);
    ...
    <footer style="margin-top: 3rem; padding-top: 1rem; border-top: 1px solid var(--border); color: #8b949e; font-size: 0.9rem;">
        ...
        <p>See <code>docs/research/ABSTRACT_ANAPHORA_RESEARCH.md</code> for research background.</p>
    </footer>
</body>
</html>"#);
